    ...
    <>
      ...
      <div className="bg-forest h-10 flex items-center justify-between px-[5%] text-[12.5px] text-[#A8C4B4] relative z-[200]">
        <div className="flex items-center gap-5">
          ...
          <Link href="tel:+08054497009" className="text-xs flex items-center gap-[5px] hover:text-gold transition-colors">
            📞 08054497009
          </Link>
        </div>
        <div className="hidden md:flex items-center gap-4">
          <Link href="https://wa.me/07010471769" target="_blank" className="text-xs hover:text-gold transition-colors">💬 WhatsApp</Link>
          <div className="w-[1px] h-4 bg-white/15"></div>
          <Link href="#" className="text-xs hover:text-gold transition-colors">✉️ Contact Us</Link>
          <div className="w-[1px] h-4 bg-white/15"></div>
      ...
      <nav className="bg-white h-[68px] border-b border-brandBorder sticky top-0 z-[150] flex items-center px-[5%] justify-between">
        <Link href="#" className="flex items-center gap-[11px] shrink-0 mr-10">
          ...
          <div>
            <div className="font-serif text-xl font-bold text-dark leading-tight">Aba Crafts</div>
        ...
        <ul className="hidden lg:flex items-center gap-1 flex-1">
          ...
          <li className="relative group">
            ...
            <div className="absolute top-[calc(100%+8px)] -left-[60px] bg-white border border-brandBorder rounded-xl shadow-brand-lg w-[560px] p-6 grid grid-cols-2 gap-6 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transform translateY(8px) group-hover:translate-y-0 transition-all duration-200 z-[300]">
              <div className="flex flex-col gap-3">
                ...
                <Link href="#" className="flex gap-3 p-2 rounded-lg hover:bg-clay-light transition-colors group/item">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Link href="#" className="flex gap-3 p-2 rounded-lg hover:bg-clay-light transition-colors group/item">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted">Wood & rattan crafts</div>
                  </div>
                </Link>
                <Link href="#" className="flex gap-3 p-2 rounded-lg hover:bg-clay-light transition-colors group/item">
                  <span className="text-xl">🏭</span>
          ...
          <li className="relative group">
            ...
            <div className="absolute top-[calc(100%+8px)] left-0 bg-white border border-brandBorder rounded-xl shadow-brand-lg min-w-[220px] py-2 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transform translateY(8px) group-hover:translate-y-0 transition-all duration-200 z-[300]">
              <Link href="#" className="flex items-center gap-[10px] px-[18px] py-[10px] text-[13.5px] hover:bg-clay-light hover:text-clay transition-colors"><span>🛒</span> Buying Guide</Link>
              <Link href="#" className="flex items-center gap-[10px] px-[18px] py-[10px] text-[13.5px] hover:bg-clay-light hover:text-clay transition-colors"><span>🏪</span> Become an Artisan</Link>
              <Link href="#" className="flex items-center gap-[10px] px-[18px] py-[10px] text-[13.5px] hover:bg-clay-light hover:text-clay transition-colors"><span>🚚</span> Delivery & Shipping</Link>
              <Link href="#" className="flex items-center gap-[10px] px-[18px] py-[10px] text-[13.5px] hover:bg-clay-light hover:text-clay transition-colors"><span>🔄</span> Returns Policy</Link>
            </div>
          </li>

          <li><Link href="#" className="flex items-center px-[14px] py-2 text-sm font-medium rounded-md hover:bg-clay-light hover:text-clay transition-all">Our Story</Link></li>
          <li><Link href="#" className="flex items-center px-[14px] py-2 text-sm font-medium rounded-md hover:bg-clay-light hover:text-clay transition-all">News & Blog</Link></li>
          <li><Link href="#" className="flex items-center px-[14px] py-2 text-sm font-medium rounded-md hover:bg-clay-light hover:text-clay transition-all">FAQ</Link></li>
        </ul>

        {/* CTA Buttons */}
        <div className="hidden lg:flex items-center gap-3">
          <Link href="auth/sign-in" className="border border-clay text-clay text-[13.5px] font-semibold px-5 py-[10px] rounded-lg hover:bg-clay hover:text-white transition-all">Sell on Aba Crafts</Link>
          <Link href="#" className="bg-clay text-white text-[13.5px] font-semibold px-5 py-[10px] rounded-lg hover:bg-clay-dark transition-all">Shop Now →</Link>
        </div>
      ...
      <div className={`fixed top-[68px] right-0 bottom-0 w-[300px] bg-white border-l border-brandBorder p-6 flex flex-col gap-2 z-[190] lg:hidden overflow-y-auto transition-transform duration-300 ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div>
          ...
          <div className={`flex flex-col gap-2 pl-4 overflow-hidden transition-all duration-300 ${mobileSubMenu === 'products' ? 'max-h-[300px] mt-2' : 'max-h-0'}`}>
            <Link href="#" className="py-2 text-sm text-muted">👟 Footwear</Link>
            <Link href="#" className="py-2 text-sm text-muted">👜 Bags & Leather</Link>
            <Link href="#" className="py-2 text-sm text-muted">👘 Fashion & Garments</Link>
            <Link href="#" className="py-2 text-sm text-muted">🪑 Furniture & Décor</Link>
            <Link href="#" className="py-2 text-sm text-muted">🏭 Wholesale</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className={`flex flex-col gap-2 pl-4 overflow-hidden transition-all duration-300 ${mobileSubMenu === 'how-it-works' ? 'max-h-[250px] mt-2' : 'max-h-0'}`}>
            <Link href="#" className="py-2 text-sm text-muted">🛒 Buying Guide</Link>
            <Link href="#" className="py-2 text-sm text-muted">🏪 Become an Artisan</Link>
            <Link href="#" className="py-2 text-sm text-muted">🚚 Delivery & Shipping</Link>
            <Link href="#" className="py-2 text-sm text-muted">🔄 Returns Policy</Link>
          </div>
        </div>

        <Link href="#" className="py-[10px] border-b border-brandBorder text-[15px] font-medium text-dark">Our Story</Link>
        <Link href="#" className="py-[10px] border-b border-brandBorder text-[15px] font-medium text-dark">News & Blog</Link>
        <Link href="#" className="py-[10px] border-b border-brandBorder text-[15px] font-medium text-dark">FAQ</Link>

        <div className="flex flex-col gap-3 mt-6">
          <Link href="#" className="border border-clay text-clay text-center py-3 rounded-lg font-semibold text-sm">Contact Us</Link>
          <Link href="#" className="bg-clay text-white text-center py-3 rounded-lg font-semibold text-sm">Shop Now →</Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Link href="#" className="bg-clay text-white font-semibold px-7 py-4 rounded-xl hover:bg-clay-dark shadow-md transition-all">Shop All Products →</Link>
              <Link href="#" className="border border-brandBorder bg-white/50 backdrop-blur-sm font-semibold px-7 py-4 rounded-xl hover:bg-white transition-all text-dark">Our Story</Link>
            </div>
      ...
      <section className="py-20 bg-white px-[5%]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
            {[
              { id: 'Bags', label: ' Bags', img: 'https://images.unsplash.com/photo-1547949003-9792a18a2601?w=500' },
              { id: 'Belts', label: ' FootWear', img: 'https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=500' },
              { id: 'fashion', label: ' Fashion', img: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=500' },
              { id: 'Accessory', label: ' Accessory', img: '/aba-crafts-2.png' },
              { id: 'wholesale', label: ' Wholesale', img: '/aba-crafts-7.png' },
      ...
      {/* FEATURED PRODUCTS */}
      <section section className="py-20 bg-cream px-[5%]" >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            ...
            <Link href="#" className="text-clay font-bold text-sm hover:underline shrink-0 flex items-center">View All Products →</Link>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Classic Aba Leather Oxford", cat: "Footwear", price: "₦18,500", desc: "Hand-stitched genuine leather, durable sole. Available in all sizes. A staple from Aba's master cobblers.", img: "https://images.unsplash.com/photo-1647672988733-5679b9ffccc7?q=80&w=627&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
              ...
              { title: "Bespoke custom-made foot-wears", cat: "Fashion", price: "₦25,000", desc: "custom-made footwares, send your measurements. 7-day turnaround from Aba.", img: "https://images.unsplash.com/photo-1780327007439-d78065bf157d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
              { title: "Belts", cat: "Accessory", price: "₦9,500", desc: "Lightweight, breathable belts hand-carved from premium cowhide. Comfortable for all-day wear.", img: "https://images.unsplash.com/photo-1664285612706-b32633c95820?q=80&w=958&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
              ...
              <div key={idx} className="bg-white border border-brandBorder rounded-2xl overflow-hidden shadow-sm flex flex-col group">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-brandBorder mt-auto">
                    ...
                    <Link href="" className="text-clay text-sm font-bold flex items-center gap-1 hover:text-clay-dark">Order Now →</Link>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* WHY ABA CRAFT */}
      <section section className="py-20 bg-dark text-white px-[5%]" >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="text-gold text-sm font-bold tracking-wider uppercase mb-2">Why Aba Crafts</div>
            <h2 className="font-serif text-3xl sm:text-4xl font-black leading-tight text-white mb-4">Why Thousands Trust<br />Aba Crafts</h2>
            ...
            <div className="mt-8">
              <Link href="#" className="inline-block bg-clay text-white font-semibold px-6 py-3.5 rounded-xl hover:bg-clay-dark transition-all text-sm">Learn Our Story →</Link>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {[
              { title: "Verified Artisans", desc: "Every craftsman is vetted for quality before listing. No middlemen, no fakes." },
              { title: "Nationwide Delivery", desc: "We deliver to all 36 states. Fast, tracked, and insured shipments." },
              { title: "Buyer Protection", desc: "Not happy? Full refund or replacement — no questions asked within 7 days." },
              { title: "WhatsApp Support", desc: "Chat with our team 24/7. Custom orders, bulk pricing, and more." }
            ].map((f, i) => (
      ...
      {/* HOW IT WORKS */}
      <section section className="py-20 bg-white px-[5%]" >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link href="#" className="text-clay font-bold text-sm hover:underline">Full Process Details →</Link>
          </div>
        </div>
      </section >
      ...
      <section section className="py-20 bg-cream px-[5%]" >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Emeka Okonkwo", loc: "Lagos State • Footwear Buyer", initial: "EO", bg: "bg-clay", color: "text-white", text: "I ordered custom leather shoes for my wedding and they were absolutely perfect — rivals anything from Lagos boutiques, at half the price. Aba Crafts is something special." },
              { name: "Fatima Danladi", loc: "Abuja • Wholesale Buyer", initial: "FD", bg: "bg-forest", color: "text-white", text: "As a retailer in Abuja, finding consistent quality from Aba was always a challenge. Aba Crafts solved that completely. My wholesale orders arrive on time, every time." },
              { name: "Chukwuemeka Nwosu", loc: "London, UK • Diaspora Customer", initial: "CN", bg: "bg-gold", color: "text-dark", text: "Being in London and wanting authentic Nigerian-made goods has always been hard. Aba Crafts ships internationally and the packaging is beautiful. I am now a regular customer." }
            ].map((t, idx) => (
      ...
      {/* CTA BANNER */}
      <section section className="bg-clay text-white py-16 px-[5%] text-center relative overflow-hidden" >
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="#" className="bg-white text-clay font-bold px-7 py-3.5 rounded-xl hover:bg-cream transition-all text-sm">Shop Now</Link>
            <Link href="https://wa.me/7010471769" className="border border-white/40 bg-white/10 backdrop-blur-sm text-white font-bold px-7 py-3.5 rounded-xl hover:bg-white/20 transition-all text-sm">💬 Chat on WhatsApp</Link>
          </div>
        </div>
      </section >

      {/* FOOTER */}
      <section footer className="bg-dark text-white pt-16 pb-8 px-[5%] border-t border-white/5" >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-white/10">
          <div className="lg:col-span-2 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              ...
              <span className="font-serif text-lg font-bold text-white">Aba Crafts</span>
            </div>
            ...
            <div key={colIdx}>
              ...
              <ul className="flex flex-col gap-3 text-sm text-white/50">
                ...
                {title === "Support" && <>
                  ...
                  <li><Link href="#" className="hover:text-white transition-colors">Raise a Complaint</Link></li>
                </>}
              </ul>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row justify-between items-center text-xs text-white/40 gap-4">
          <span>© 2026 Aba Crafts. All rights reserved.</span>
